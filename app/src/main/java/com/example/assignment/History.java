...
public class History {
    ...
    String destination_name, origin_name, seat_type, seat_no, train_date, seat_coach;

    public History(){}

    public History(String destination_name, String origin_name, String seat_type, String seat_no, String train_date, String seat_coach) {
