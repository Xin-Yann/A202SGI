...
import androidx.appcompat.app.AppCompatActivity;
public class Select_seat_c extends AppCompatActivity {
    ...
    private void checkAndDisplaySeatAvailability(final String seatId, final ImageButton normalSeatButton) {
        ...
        db.collection("departseat")
                ...
                .addOnFailureListener(e -> {
                    Toast.makeText(Select_seat_c.this, "Error checking seat availability", Toast.LENGTH_SHORT).show();
                });
    }
    ...
    private void saveSelectedSeat(String seatId) {
        ...
        db.collection("departseat")
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    Toast.makeText(Select_seat_c.this, "Seat data added to database", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {

                    Toast.makeText(Select_seat_c.this, "Error adding seat data to database", Toast.LENGTH_SHORT).show();
                });
    }
